...
int main()
{
    ...
    while(t--)
    {
        ...
        Point a1(x_1, y_1);
        Point b1(x_2, y_2);
        Vector v1(x_1-x_2, y_1-y_2);

        Point a2(x_3, y_3);
        Point b2(x_4, y_4);
        Vector v2(x_3-x_4, y_3-y_4);
        ...
        int line1ans = getLineCircleIntersecion(line1, o, t1, t2, sol);
        int line2ans = getLineCircleIntersecion(line2, o, t1, t2, sol);

        Point squr41 = getLineCircleIntersecion(a1, v1, co, v2);
        Point squr42 = getLineCircleIntersecion(a2, v2, co, v1);

//        Vector()
//        double anglecnt = Angle()
        printf("wawawawa\n");
